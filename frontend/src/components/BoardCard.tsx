...
export function BoardCard({
  ...
  return (
    <article className="group w-full min-w-0 overflow-hidden rounded-lg border border-white/10 bg-[#1f222a] shadow-sm transition hover:-translate-y-0.5 hover:border-white/20 sm:w-[248px]">
      <Link
